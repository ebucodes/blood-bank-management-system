                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="add.php" class="btn btn-primary"><i class="fa fa-plus-circle"></i> New Donor</a>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <!-- /.row -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="example1" class="table table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($conn, "SELECT * FROM `donors`") or die(mysqli_error($conn));
                                                    $count = 1;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $age; ?></td>
                                                            <td><?php echo $address . ', ' . $lga . ', ' . $state; ?></td>
                                                            <td>
                                                            ...
                                                            ?>
                                                                <td>
                                                                    <span class="badge badge-warning"><?php echo $user_type; ?></span>
                                                                </td>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                <td>
                                                                    <span class="badge badge-success"><?php echo "User"; ?></span>
                                                                </td>
                                                            <?php
                                                            }
