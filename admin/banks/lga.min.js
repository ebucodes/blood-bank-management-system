...
const setAttributes = (a, o) => { for (var i in o) a.setAttribute(i, o[i]) }, toggleLGA = a => {
    let o = {
        ...
        Delta: ["Asaba","Aniocha North", "Aniocha South", "Bomadi", "Burutu", "Ethiope East", "Ethiope West", "Ika North East", "Ika South", "Isoko North", "Isoko South", "Ndokwa East", "Ndokwa West", "Okpe", "Oshimili North", "Oshimili South", "Patani", "Sapele", "Udu", "Ughelli North", "Ughelli South", "Ukwuani", "Uvwie", "Warri North", "Warri South", "Warri South West"],
        Ebonyi: ["Abakaliki", "Afikpo North", "Afikpo South", "Ebonyi", "Ezza North", "Ezza South", "Ikwo", "Ishielu", "Ivo", "Izzi", "Ohaozara", "Ohaukwu", "Onicha"],
        Edo: ["Akoko-Edo", "Benin", "Egor", "Esan Central", "Esan North-East", "Esan South-East", "Esan West", "Etsako Central", "Etsako East", "Etsako West", "Igueben", "Ikpoba Okha", "Orhionmwon", "Oredo", "Ovia North-East", "Ovia South-West", "Owan East", "Owan West", "Uhunmwonde"],
        ...
        Lagos: ["Agege", "Ajeromi-Ifelodun", "Alimosho", "Amuwo-Odofin", "Apapa", "Badagry", "Bariga", "Epe", "Eti Osa", "Ibeju-Lekki", "Ifako-Ijaiye", "Ikeja", "Ikorodu", "Kosofe", "Lagos Island", "Lagos Mainland", "Mushin", "Ojo", "Oshodi-Isolo", "Shomolu", "Surulere", "Yaba"],
    ...
    }[a.value], u = ["Select LGA...", ...Object.values(o)], e = a.parentElement.parentElement.parentElement.parentElement.querySelector(".select-lga"), r = e.options.length; for (i = r - 1; i >= 0; i--)e.options[i] = null; u.forEach(a => { let o = document.createElement("option"); o.appendChild(document.createTextNode(a)), o.value = a, a.includes("elect") && setAttributes(o, { disabled: "disabled", selected: "selected" }), e.appendChild(o) })
};
