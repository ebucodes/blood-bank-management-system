...
<div class="modal fade text-white" id="edit<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $edit = mysqli_query($conn, "SELECT * FROM request WHERE id='" . $row['id'] . "'");
                ...
                <div class="container-fluid">
                    <form action="update.php?id=<?php echo $editRow['id']; ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input type="text" name="name" value="<?php echo $editRow['status']; ?>" class="form-control" readonly> -->
                        </div>
                        <hr>
                        <div class="form-group">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <h4>
                        Are you sure to delete <strong><?php echo ucwords($deleteRow['name']); ?></strong> 's request'.
                    </h4>
                    <h5>
